...
categories: [3d perception, multi-sensor, limited supervision]
...
![octet_overview]({{ site.baseurl }}/images/posts/2023_cvpr/octet.png){:height="100%" width="100%"}
...
![found_overview]({{ site.baseurl }}/images/posts/2023_cvpr/found.png){:height="50%" width="50%"}
