...
![advent_teaser]({{ site.baseurl }}/images/posts/advent/advent_teaser.png){:height="60%" width="60%"}
...
![]({{ site.baseurl }}/images/posts/advent/advent_approach.jpg){:height="100%" width="100%"}
...
![]({{ site.baseurl }}/images/posts/advent/advent_table1.png){:height="60%" width="60%"}
...
![]({{ site.baseurl }}/images/posts/advent/advent_qualitative.png ){:height="100%" width="100%"}
...
![]({{ site.baseurl }}/images/posts/advent/advent_table2.png ){:height="60%" width="60%"}
