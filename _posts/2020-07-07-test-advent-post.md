...
![advent_teaser]({{ site.baseurl }}/images/advent/advent_teaser.png){:height="60%" width="60%"}
...
![]({{ site.baseurl }}/images/advent/advent_table1.png){:height="60%" width="60%"}
...
![]({{ site.baseurl }}/images/advent/advent_table2.png ){:height="60%" width="60%"}
