...
![advent_teaser]({{ site.baseurl }}/images/advent/advent_teaser.png){:height="80%" width="80%"}
...
![]({{ site.baseurl }}/images/advent/advent_table1.png){:height="80%" width="80%"}
...
![]({{ site.baseurl }}/images/advent/advent_qualitative.png ){:height="100%" width="100%"}
...
![]({{ site.baseurl }}/images/advent/advent_table2.png ){:height="70%" width="70%"}
