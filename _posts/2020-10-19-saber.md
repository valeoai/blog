...
*Figure 1: World record scores vs. the usual beginner human baseline {% cite dabney2018implicit %} (log scale).*
...
![apex_arch]({{ site.baseurl }}/images/posts/saber/apppex_arch.png){:height="60%" width="60%"}
